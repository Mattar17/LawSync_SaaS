...
export default function LawyerInvites() {
  ...
  return (
    <div dir="rtl" className="dashboard-page">
      <div className="dashboard-container max-w-3xl space-y-8">
        {/* My Offices */}
        <section className="space-y-4">
          <div>
            <p className="dashboard-kicker">إدارة المكتب</p>
            <h1 className="dashboard-title">مكاتبي</h1>
        ...
        <section className="space-y-4">
          <div>
            <p className="dashboard-kicker">مساحة العمل</p>
            <h2 className="dashboard-title">الدعوات</h2>
            <p className="dashboard-subtitle">
